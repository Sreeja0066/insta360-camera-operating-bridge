...
class DriveUploader(private val context: Context) {
    ...
    /**
     * Add a file path to the pending upload queue.
     */
    ...
    /**
     * Remove a file from the pending queue after successful upload.
     */
    ...
    /**
     * Finds the 'Insta360Bridge' folder or creates it if not found.
     */
    ...
    /**
     * Upload a file. If no internet, queues it for later.
     */
    ...
    /**
     * Upload all pending files. Called when internet becomes available.
     */
